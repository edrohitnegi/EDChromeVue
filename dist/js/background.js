...
var RESPONSE_TYPE = encodeURIComponent('token');
var REDIRECT_URI = encodeURIComponent(chrome.identity.getRedirectURL()); //https://chromeext_id.chromiup.app/ something

var STATE = encodeURIComponent('edlink');
var SCOPE = encodeURIComponent('identify email');
...
function get_discord_uri() {
  ...
  var url = "".concat(DISCORD_URI, "?client_id=").concat(CLIENT_ID, "&response_type=").concat(RESPONSE_TYPE, "&redirect_uri=").concat(REDIRECT_URI, "&state=").concat(STATE, "&scope=").concat(SCOPE, "&nonce=").concat(nonce);
  console.log(url);
  return url;
