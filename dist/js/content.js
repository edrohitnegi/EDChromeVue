...
"use strict";
var __WEBPACK_AMD_DEFINE_ARRAY__, __WEBPACK_AMD_DEFINE_RESULT__;var _typeof="function"==typeof Symbol&&"symbol"==typeof Symbol.iterator?function(e){return typeof e}:function(e){return e&&"function"==typeof Symbol&&e.constructor===Symbol&&e!==Symbol.prototype?"symbol":typeof e};
//! annyang
//! version : 2.6.1
...
//! license : MIT
//! https://www.TalAter.com/annyang/
!function(e,n){ true?!(__WEBPACK_AMD_DEFINE_ARRAY__ = [], __WEBPACK_AMD_DEFINE_RESULT__ = (function(){return e.annyang=n(e)}).apply(exports, __WEBPACK_AMD_DEFINE_ARRAY__),
...
/***/ "./assets/js/modules/discord_connect.js":
/*!**********************************************!*\
  !*** ./assets/js/modules/discord_connect.js ***!
  \**********************************************/
/***/ ((module, __unused_webpack_exports, __webpack_require__) => {

var json_transform = __webpack_require__(/*! ./json_transform */ "./assets/js/modules/json_transform.js");
...
function DiscordSend() {
  var whurl = 'https://discord.com/api/webhooks/824505278002888724/PZQ6rS-PY1yHPNl0CCateeHe6nQY4_97oAeYmfyRCrjyatDNGCHgiz0bA7G5OUVdVscA'; //Use this for JSON Send

  var jmsg = {
    "content": "`" + "".concat(JSON.stringify(json_transform.JSONTransform)) + "`",
    "username": "BOOST!!!",
    "avatar_url": "https://i1.wp.com/www.edvanta.com/wp-content/uploads/2017/05/favicon.png?fit=32%2C31&ssl=1" // {"links":"fogooo.com"} nahi le rha

  }; //Use this for structured Message send

  var msg = {
    "content": "**Title**: ".concat(document.title, "\n**URL**: ").concat(window.location.href, "\n**DATE**: ").concat(current_time),
    "username": "BOOST!!!",
...
/***/ "./assets/js/modules/download.js":
/*!***************************************!*\
  !*** ./assets/js/modules/download.js ***!
  \***************************************/
/***/ ((module) => {

var JsonObjectData = {}; // Download CSV Function
...
function downloadJSON() {
  ...
  chrome.storage.sync.get(['links'], function (result) {
    ...
    var custom_csv = result.links;
    var jsonTitle = [];
    var JsonLinks = []; // var JsonObjectData = {}
    ...
    JsonObjectData["links"] = JsonLinks; // Download
...
module.exports = {
  instant_execute: instant_execute
};

/***/ }),

/***/ "./assets/js/modules/json_transform.js":
/*!*********************************************!*\
  !*** ./assets/js/modules/json_transform.js ***!
  \*********************************************/
/***/ ((module) => {
...
/***/ "./assets/js/modules/linkstore.js":
/*!****************************************!*\
  !*** ./assets/js/modules/linkstore.js ***!
  \****************************************/
/***/ ((module, __unused_webpack_exports, __webpack_require__) => {
...
var current_time = moment().format('LLL'); // It will store your link
...
var linkstore = __webpack_require__(/*! ./modules/linkstore */ "./assets/js/modules/linkstore.js");

var download = __webpack_require__(/*! ./modules/download */ "./assets/js/modules/download.js");

var instant = __webpack_require__(/*! ./modules/instant */ "./assets/js/modules/instant.js");

var _short = __webpack_require__(/*! ./modules/shorthands */ "./assets/js/modules/shorthands.js");

var any = __webpack_require__(/*! annyang */ "./node_modules/annyang/dist/annyang.min.js"); //To Store Link


linkstore.LinkStore(); // To execute instant

instant.instant_execute(); // Shorcut Key definition
